    ...
    return {
      ...
      sections: [
        ...
        },
        {
          ...
          content: '',
          tableData: {
            headers: ['Rank', 'Partner', 'SEAM™ Score', 'Key Strength', 'Consideration'],
      ...
      appendices: [
        {
          ...
          type: 'paragraph',
          content: `This analysis was conducted using the BW Nexus AI Strategic Intelligence Platform, incorporating 21 proprietary NSIL formulas across market analysis, partner matching, financial modeling, and risk assessment. Data sources include World Bank, local government statistics, industry databases, and proprietary intelligence networks.`
        },
        {
...
<body>
    ...
    <div class="document-footer">
        ...
        <p>Generated by BW Nexus AI Strategic Intelligence Platform</p>
    </div>
</body>
</html>`;
  }
